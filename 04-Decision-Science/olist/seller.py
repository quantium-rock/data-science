...
class Seller:
    ...
    def get_review_score(self):
        ...
        sellers_review_score = pd.merge(order_items, review_score, on='order_id').groupby('seller_id').mean().round(2).reset_index()
        sellers_review_score = sellers_review_score.rename(columns={'dim_is_five_star':'share_of_five_star', 'dim_is_one_star':'share_is_one_star'})
        
        return sellers_review_score[['seller_id','share_of_five_star','share_is_one_star','review_score']]
